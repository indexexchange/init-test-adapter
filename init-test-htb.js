...
var PartnerSpecificValidator = require('init-test-htb-validator.js');
...
function InitTestHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'InitTestHtb', // PartnerName
            namespace: 'InitTestHtb', // Should be same as partnerName
            statsId: 'TEST', // Unique partner identifier
            version: '2.1.1',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
